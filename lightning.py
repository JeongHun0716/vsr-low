...
def compute_character_level_distance(seq1, seq2):
    seq1 = list(seq1.replace(' ', '').lower())
    seq2 = list(seq2.replace(' ', '').lower())
    return torchaudio.functional.edit_distance(seq1, seq2), len(seq1)
...
class ModelModule(LightningModule):
    def __init__(self, cfg):
        ...
        self.model_pth = cfg.sp_model_path
        self.dict_pth = cfg.dict_path


        self.text_transform = TextTransform(sp_model_path=self.model_pth, dict_path=self.dict_pth)
    ...
    def test_step(self, sample, sample_idx):
        ...
        total_char_edit_distance, char_length = compute_character_level_distance(actual, predicted)
        self.total_char_edit_distance += total_char_edit_distance
        self.total_length += len(actual.split())
        self.total_char_length += char_length
        return
    ...
    def on_test_epoch_end(self):
        ...
        self.log("cer", self.total_char_edit_distance / self.total_char_length)
